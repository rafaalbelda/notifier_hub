    ...
    return vol.Schema(
        {
            ...
            vol.Optional(CONF_TEXT_NOTIFICATIONS, default=default(CONF_TEXT_NOTIFICATIONS, True)): selector.BooleanSelector(),
            vol.Optional(CONF_SCREEN_NOTIFICATIONS, default=default(CONF_SCREEN_NOTIFICATIONS, True)): selector.BooleanSelector(),
            vol.Optional(CONF_SPEECH_NOTIFICATIONS, default=default(CONF_SPEECH_NOTIFICATIONS, True)): selector.BooleanSelector(),
